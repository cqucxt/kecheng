...
int main() {
	...
	DWORD el_anew = dosheader->e_lfanew;
	DWORD byteofthis = 24 + nt_header->FileHeader.SizeOfOptionalHeader + 40 * nt_header->FileHeader.NumberOfSections;
...
//修改EL_anew
	...
	UINT8 data[] = { 0x90, 0x02, 0x00, 0x00 };

	DWORD el_anewweizhi = 0x3c;
	DWORD byteofthis1 = 4;
